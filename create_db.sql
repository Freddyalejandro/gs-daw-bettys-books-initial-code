...
# Create the tables
CREATE TABLE IF NOT EXISTS books (id INT AUTO_INCREMENT,name VARCHAR(50),price DECIMAL(5, 2),author VARCHAR(50), publisher VARCHAR(50),  publication_date data('DD/MM/YYYY'), unsigned,PRIMARY KEY(id));
